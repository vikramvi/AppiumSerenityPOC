...
@CucumberOptions(features="src/test/java/resources/features/WineAppGettingStarted.feature" , plugin = {"json:target/cucumber_json/cucumber.json"} )
public class WineAppCucumber {
