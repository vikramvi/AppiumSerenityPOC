...
//        BREWERY("(//android.widget.TextView[@content-desc='growler-card-header-brewery'])[%d]"),
//        BEER("(//android.widget.TextView[@content-desc='growler-card-header-beer'])[%d]"),
//        ABV_LABEL("(//android.widget.TextView[@content-desc='growler-card-abv-label'])[%d]"),
//        ABV_VALUE("(//android.widget.TextView[@content-desc='growler-card-abv-value'])[%d]"),
//        IBU_LABEL("(//android.widget.TextView[@content-desc='growler-card-ibu-label'])[%d]"),
//        IBU_VALUE("(//android.widget.TextView[@content-desc='growler-card-ibu-value'])[%d]"),
//        SMALL_FILL_LABEL("(//android.widget.TextView[@content-desc='growler-small-label'])[%d]"),
//        SMALL_FILL_COST("(//android.widget.TextView[@content-desc='growler-small-price'])[%d]"),
//        LARGE_FILL_LABEL("(//android.widget.TextView[@content-desc='growler-large-label'])[%d]"),
//        LARGE_FILL_COST("(//android.widget.TextView[@content-desc='growler-large-price'])[%d]");
//
//        private String xpathPattern;
//        AndroidGrowlerCard(String xpathPattern) {
